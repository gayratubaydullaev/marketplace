...
func main() {
	...
	dash.GET("/balance", vendors.Balance)
	...
	v1.GET("/admin/tenant/settings", middleware.JWT(tokens, false), middleware.RequireRoles(commonauth.RoleTenantAdmin, commonauth.RoleSuperAdmin), vendors.GetTenantSettings)
