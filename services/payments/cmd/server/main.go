...
func main() {
	...
	v1.GET("/providers/health", middleware.JWT(tokens, false), middleware.RequireRoles(commonauth.RoleTenantAdmin, commonauth.RoleManager, commonauth.RoleSuperAdmin), payments.ProvidersHealth)
	v1.POST("/admin/mark-paid", middleware.JWT(tokens, false), middleware.RequireRoles(commonauth.RoleTenantAdmin, commonauth.RoleManager), payments.AdminMarkPaid)
	v1.POST("/admin/confirm-refund", middleware.JWT(tokens, false), middleware.RequireRoles(commonauth.RoleTenantAdmin, commonauth.RoleManager), payments.AdminConfirmRefund)
